...
gadget_file = open('snfs_gadgets.txt') #File of Gadgets, written with rp++ output
desired_file = open('desired_gadgets1.txt') #Desired gadgets should match the format in gadget file
